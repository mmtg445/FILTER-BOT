...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/https://t.me/RM_Movie_Flix/65')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002289024376'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Rm_Support_Groups')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002289024376')).split()]
MELCOW_NEW_USERS = is_enabled((environ.get('MELCOW_NEW_USERS', "True")), True)
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "False")), False)
PUBLIC_FILE_STORE = is_enabled((environ.get('PUBLIC_FILE_STORE', "True")), True)

LANGUAGES = ["malayalam", "mal", "tamil", "tam" ,"english", "eng", "hindi", "hin", "bangla", "ben", "telugu", "tel", "kannada", "kan"]
